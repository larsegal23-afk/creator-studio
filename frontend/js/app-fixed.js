...
async function loadCoins() {
  try {
    ...
    const res = await window.authfetch("https://logomakergermany-ultimate-backend-production.up.railway.app/api/get-coins");
...
async function useCoins(amount) {
  try {
    const res = await window.authFetch("https://logomakergermany-ultimate-backend-production.up.railway.app/api/use-coins", {
      method: "POST",
