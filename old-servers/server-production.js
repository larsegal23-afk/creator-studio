...
try {
  if (process.env.FIREBASE_PROJECT_ID && process.env.FIREBASE_PRIVATE_KEY) {
    ...
    console.error("Please set FIREBASE_PROJECT_ID and FIREBASE_PRIVATE_KEY in .env.production")
    process.exit(1)
  }
} catch (error) {
...
// MANDATORY COINS HELPER - SERVER SIDE
...
// Use coins - SERVER SIDE VALIDATION
